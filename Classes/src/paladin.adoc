...
melee weapon attack, you can deal extra radiant damage to the target,
in addition to the weapon's damage. The extra damage is a Xd8, where X
is 1 + the level of the higher spell level that you can cast.
...
All the expended uses are recharged after a Long Rest.
