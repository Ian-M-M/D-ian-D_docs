...
|*_Level_* a|*_Prof. Bonus_*|*_Features_*                                                             |*_Infusions Known_* |*_Infused Items_* |*_Cantrips Known_* |*_1st_* |*_2nd_* |*_3rd_* |*_4th_* |*_5th_*
...
|*8th*      |*+3*           |*Feat*                                                                   |*6* |*3* |*2* |*4* |*3* |*—* |*—* |*—*
|*9th*      |*+4*           |*Artificer Specialist Feature*                                           |*6* |*3* |*2* |*4* |*3* |*2* |*—* |*—*
|*10th*     |*+4*           |*Magic Item Adept*                                                       |*8* |*4* |*3* |*4* |*3* |*2* |*—* |*—*
|*11th*     |*+4*           |*Spell-Storing Item*                                                     |*8* |*4* |*3* |*4* |*3* |*3* |*—* |*—*
|*12th*     |*+4*           |*Feat*                                                                   |*8* |*4* |*3* |*4* |*3* |*3* |*—* |*—*
