...
|*15th*     |*+5*             |*Fighting Feat, Martial Archetype feature*
|*16th*     |*+5*             |*Feat*
|*17th*     |*+6*             |*Action Surge (two uses), Indomitable (three uses), Unconquerable*
...
When you reach 5th level, you can choose one of the following options:

- Increase one ability score of your choice by 2, or you can increase 
two ability scores of your choice by 1. 
- Choose a Feat.
- Choose a Fighting Style.
- Choose a Battle Maneuver.
...
When you reach 15th level, you can choose one of the following options:
