...
|*_Level_* a| *_Prof. Bonus_* |*_Features_*                                         |*_Cantrips Known_* |*_1st_* |*_2nd_* |*_3rd_* |*_4th_* |*_5th_* |*_6th_* |*_7th_* |*_8th_* |*_9th_*
|*1st*      |*+2*             |*Bardic Inspiration, Spellcasting*                   |*2* |*2* |*—* |*—* |*—* |*—* |*—* |*—* |*—* |*—*
|*2nd*      |*+2*             |*Jack of All Trades, Song of Rest (d6)*              |*2* |*3* |*—* |*—* |*—* |*—* |*—* |*—* |*—* |*—*
|*3rd*      |*+2*             |*Bard College, Expertise, Magical Inspiration*       |*2* |*4* |*2* |*—* |*—* |*—* |*—* |*—* |*—* |*—*
|*4th*      |*+2*             |*Feat*                                               |*3* |*4* |*3* |*—* |*—* |*—* |*—* |*—* |*—* |*—*
...
You have access to the Art spell list. Whenever you finish a Long Rest, 
you can replace any Spell you have prepared for this Spell list with 
another Spell from that Spell list.
...
==== *Preparing and Casting Spells from other spell list*

As a bard, your knowledge of other source of magic is limited, coming from
this you are able to cast them but with some limitations. This spells count 
as bard spell for you, so they follow the same rules as a regular bard spell.

The amount of spells from other spell list that you can prepare for each level
is determined by the amount of spell slots that you have for each level halved
(rounded down).
