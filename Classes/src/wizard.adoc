...
|*1st*      |*+2*            |*Spellcasting, School Speciality*   |*3*                |*2*     |*—*     |*—*     |*—*     |*—*     |*—*     |*—*     |*—*     |*—*
...
|*20th*     |*+6*            |*Create Spell*                      |*5*                |*4*     |*3*     |*3*     |*3*     |*3*     |*2*     |*2*     |*1*     |*1*
|===
...
At 1st level, you have practice one school as your speciality. You can
choose one school of magic and gain the following feature related to that
school:
