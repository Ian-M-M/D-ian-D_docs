...
|*3rd*     |*+2*            |*Primal Path, Primal Knowledge 1*    |*3*       |*+2*
|*4th*     |*+2*            |*Feat, Reckless Skill*               |*3*       |*+2*
|*5th*     |*+3*            |*Extra Attack, Fast Movement*        |*3*       |*+2*
|*6th*     |*+3*            |*Path Feature*                       |*4*       |*+2*
|*7th*     |*+3*            |*Feral Instinct, Instinctive Pounce* |*4*       |*+2*
|*8th*     |*+3*            |*Feat*                               |*4*       |*+2*
|*9th*     |*+4*            |*Brutal Critical (1 die)*            |*4*       |*+3*
|*10th*    |*+4*            |*Path feature,  Primal Knowledge 2*  |*4*       |*+3*
...
At 3rd level, you gain proficiency in one skill of your choice from the 
...
At 4th level, you can use your rage to fuel your next checks. Before rolling 
a check you can spend a use of your rage to gain advantage in the next X checks, 
where X is the rage damage of your rage.
...
At 10th level, you gain proficiency in one skill of your choice from the 
list of skills available to barbarians at 1st level.
