...
|===
|*_Level_* |*_Prof. Bonus_* |*_Features_*                                              |*_Martial Arts_* |*_Ki Points_* |*_Unarmored Movement_*
|*1st*     |*+2*            |*Unarmored Defense, Martial Arts*                         |*1d6*            |*—*           |*—* 
|*2nd*     |*+2*            |*Ki, Dedicated Weapon, Unarmored Movement*                |*1d6*            |*2*           |*+10 ft.*
|*3rd*     |*+2*            |*Deflect Missiles, Monastic Tradition, Ki-Fueled Attack*  |*1d6*            |*3*           |*+10 ft.*
|*4th*     |*+2*            |*Feat, Slow Fall, Quickened Healing*                      |*1d6*            |*4*           |*+10 ft.*
