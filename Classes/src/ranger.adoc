...
At 1st level, as an action you can sense the natural creatures that are 
up to 60 ft to you. Those creatures are humanoids and beasts.
...
Choose a type of favored enemy, and gain the traits related to that given 
creature type:
...
In addition, you gain the Sylvan language. You can sense this creature 
type while using the Nature's Sense trait.
...
this feature. In addition you gain the language Deep Speech. You 
can sense this creature type while using the Nature's Sense trait.
- *Undead.* When you are reduced to 0 hit points but not killed outright,
you can drop to 1 hit point instead. You can't use this feature again 
until you finish a long rest. In addition you have always prepared 
the Speak with Dead spell ath 9th level. You can sense this creature 
type while using the Nature's Sense trait.
