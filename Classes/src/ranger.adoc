...
=== Hunter's Partner
// Give 3 base kind (Land, Sea and Sky) of pets, let the player choose 1 Animalistic Invocation for each Pet.
//  - Let the subclasses add a trait or an attack to the Pet. 
