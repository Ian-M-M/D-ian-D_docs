== *Ranger*
// The rework should remove all the expertise related traits an focus on pet features.
[width="100%",cols="11%,6%,54%,9%,4%,4%,4%,4%,4%",options="header",]
|===
| | | | |*_Spell Slots per Spell Level_* | | | |
|*_Level_* a|*_Prof. Bonus_* |*_Features_*                                      |*_Cantrips Known_* |*_1st_* |*_2nd_* |*_3rd_* |*_4th_* |*_5th_*
// Hunter Partner: Pet defined by the subclass, subclass at first level just define the pet.
|*1st*      |*+2*            |*Fighting Style, Hunter Partner, Ranger Conclave* |*-* |*—* |*—* |*—* |*—* |*—*
// Maybe merge Favored Enemy and Terrain.
|*2nd*      |*+2*            |*Hunting Preference, Hunter's Sense*              |*-* |*—* |*—* |*—* |*—* |*—*
// Spellcasting now includes previous Nature Magic feature, but without the free casting part.
|*3rd*      |*+2*            |*Ranger Conclave feature, Spellcasting*           |*2* |*3* |*—* |*—* |*—* |*—*
|*4th*      |*+2*            |*Feat*                                            |*2* |*3* |*—* |*—* |*—* |*—*
...
=== Hunter's Partner
At 1st level you have created a bond with an entity of your preference,
a so called partner in hunt. As an action you can call that creature it
forms and behavior has to be defined by you when you create the character.

For this level you only can summon the Beast of the Land, it has the
following caracteristics:

- A base AC of 13 + you Profiency Bonus.
- Hit points equals to 5 + five times your ranger level.
- Walking and Climbing Speed of 40 ft.
...
- Primal Bond. You can add your proficiency bonus to any ability check
or saving throw that the beast makes.

Has the following Action:

- Maul. Melee Weapon Attack: your spell attack modifier to hit, reach 5 ft.,
one target. Hit: 1d8 + 2 + Proficiency Bonus slashing damage.

Additionally, you can choose 1 Druidic Animalistic Invocation to add to this
creature, to do so you need to meet the perrequisite requiremerents.

This creature benefits from spells that allow you to deal extra damage such as
Hunter´s Mark.

=== Ranger Conclave

At 1st level, you choose an conclave that you belong from the list of
available conclaves. Your choice grants features at 1st level, and
again at 3rd, 7th, 11th, and 15th level.

// 2nd Level
=== Hunter's Sense

At 2nd level, as an action you can mark a target creature that you can see up to
60 ft. While marked you can track that creature until your next Long Rest or you
reuse this feature.

Additionally, when you attack the marked creature you and your pet deal an extra 1d8 of damage.
...
Beginning at 2nd level, you have develop a certain set of skills when facing
an specific kind of creatures as well as prefered hunting ground.

Choose a type of creature, and gain the traits related to that given 
creature type:

- *Beasts*. You have always prepared the Beast Bond and the Speak with
Animals spells. 
- *Fey*. You can give yourself advantage on your next Charisma check, 
you can use this trait a number of time equals to your wisdom modifier.
In addition, you gain the Sylvan language.
- *Humanoids*. At third level you you have always prepared the Detect
Thoughts spell, and it doesn't require concentration for you. 
In addition, you gain the languages Elvish and Dwarvish.
- *Monstrosities* You can partially transform a part of your body to use it 
as a natural weapon, making your Unarmed Strike deal 1d8 of bluedgoning, 
slashing or piercing damage, you have to choose the type when using 
this feature.
- *Undead.* You gain inmunity to Charmed, Poisoned and Frightened. 

Additionally, you have studied a specific environment to overcome its
challenges. When in that environment, you gain the following benefits:
____
...
Choose one of the following environment:

- *Aquatic* You gain a swim Speed equal to your Speed. If you already had
a swim Speed, you gain +10 ft to your swim Speed. You gain resistance to
acid damage.
...
climb Speed. You gain resistance to bluedgoning damage
- *Plains* You gain +10 ft to your walking Speed. You gain resistance
to slashing damage.
- *Swamp* You gain resistance to poison and inmunity to diseases.
- *Sky* You gain +10 ft to your flying Speed, if you have one; otherwise,
you gain a flying speed of 10 ft. You gain resistance to thunder damage.
- *Urban.* You gain proficiency in Investigation and Insight. You gain resistance
to piercing damage.
