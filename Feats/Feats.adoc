...
IMPORTANT: Prerequisite: Halfling
...
=== Defensive Duelist
IMPORTANT: Prerequisite: Dexterity 13 or higher

When you are wielding a finesse weapon with which you are proficient and another creature hits you with a melee attack, you can use your reaction to add your proficiency bonus to your AC for that attack, potentially causing the attack to miss you.

=== Dragon Fear
IMPORTANT: Prerequisite: Dragonborn
...
=== Dark Elf High Magic
IMPORTANT: Prerequisite: Elf (Dark Elf)
...
=== Eldritch Adept
IMPORTANT: Prerequisite: Spellcasting or Pact Magic feature
...
=== Elemental Adept
IMPORTANT: Prerequisite: The ability to cast at least one spell
...
=== Elven Accuracy
IMPORTANT: Prerequisite: Elf or half-elf
...
=== Fey Teleportation
IMPORTANT: Prerequisite: Elf (high)
