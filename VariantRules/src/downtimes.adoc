...
Additionally, instead of spending a workweek you can spend non consecutive days and count them as a workweek, once you get a number equal to that the workweek.
...
==== Variant Check
Sometimes the downtimes requires checks that doesn't fits the parties's abilities, for those cases, the DM can provide an aditional list with another set of checks that fits the downtime. For that the number of checks required must be the same and the special check must be respected (such as the third check in Pit Fighting). 
...
include::./Downtimes/BuyingMagicItem.adoc[]
include::./Downtimes/Carousing.adoc[]
include::./Downtimes/CraftingItem.adoc[]
include::./Downtimes/Crime.adoc[]
include::./Downtimes/Gambling.adoc[]
include::./Downtimes/PitFighting.adoc[]
include::./Downtimes/Relaxation.adoc[]
include::./Downtimes/ReligiousService.adoc[]
include::./Downtimes/Research.adoc[]
include::./Downtimes/ScribingSpellScroll.adoc[]
include::./Downtimes/SellingMagicItem.adoc[]
include::./Downtimes/Training.adoc[]
include::./Downtimes/Work.adoc[]
